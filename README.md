...
This project is focused on cleaning a messy IMDb dataset using sql (MySQL). The original data had isues like missing values, inconsistent formats, duplicates, and spellling errors. 
